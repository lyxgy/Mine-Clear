...
void RevealEmpty(int row, int col) {
	...
	else if (Map[row][col] > 0) { // 数字
		// 显示数字
		switch (Map[row][col]) {
		case 1: putimage(col * 18, row * 18, &img_1); break;
		case 2: putimage(col * 18, row * 18, &img_2); break;
		case 3: putimage(col * 18, row * 18, &img_3); break;
		case 4: putimage(col * 18, row * 18, &img_4); break;
		case 5: putimage(col * 18, row * 18, &img_5); break;
		case 6: putimage(col * 18, row * 18, &img_6); break;
		case 7: putimage(col * 18, row * 18, &img_7); break;
		case 8: putimage(col * 18, row * 18, &img_8); break;
		}
		Map[row][col] = -2; // 标记为已处理
	}
}
